...
public class MainCalorieDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_calorie_display);
        setTitle("MAIN MENU");
        ...
        buttonMeals.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainCalorieDisplay.this, UpdateMeals.class);
        ...
        buttonExercise.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainCalorieDisplay.this, UpdateExercise.class);
                startActivity(intent);
            }
        });
